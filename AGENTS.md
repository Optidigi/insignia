...
The user owns product decisions. The principal architect/reviewer is ChatGPT in the Insignia Rewrite Project. The local orchestrator is sol-6-high. Implement only the authorized slice; return every PR for principal review. **M0-007** in `docs/delivery/prompts/M0-007-policy-and-checkout-boundary.md` followed the [principal's external approval of PR #9](docs/delivery/PR-009-principal-review.md) and its exact normal merge. The bounded staging experiment is complete and cleaned up; its one outcome PR awaits principal review. Do not resume Shopify mutations or start another slice from this handoff. The M0-005 whole-quote v2 exception remains a proposal, not adopted architecture. Preserve the approved plan, ledger, older protocol/source and historical evidence. The principal corrected the M0-006 native 10% fixture expectation to USD9.09 off and USD81.91 net; retain the original receipt and stop. Validation enforces exact pre-discount economics. G1/G2/G3/G5 remain IN_PROGRESS; G4/G6 have partial observations, and joint loss of both policy anchors remains an unresolved G6 guarantee. No complete gate pass, protocol freeze, production adoption, M1, released deployment or next-PR merge is authorized.
