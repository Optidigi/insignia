...
The user owns product decisions. The principal architect/reviewer is ChatGPT in the Insignia Rewrite Project. The local orchestrator is sol-6-high. Implement only the authorized slice; return every PR for principal review. The current authorization is **M0-006** in `docs/delivery/prompts/M0-006-live-carrier-and-checkout-economics.md`, following the [principal's external approval of PR #8](docs/delivery/PR-008-principal-review.md) and its exact normal merge. The live experiment is complete and cleaned up; its one outcome PR awaits principal review. The M0-005 whole-quote v2 exception remains a prototype proposal, not an adopted architecture. Preserve the approved plan, ledger, prior sources and evidence. G1 remains IN_PROGRESS with limited C/R/B acceptance, its immediate-R capture gap and #1001 cause UNDETERMINED. G2/G3/G5 remain IN_PROGRESS; G4/G6 have only limited local/staging observations. No complete gate pass or protocol freeze is authorized. Do not resume Shopify mutations, merge the M0-006 PR, deploy, or start M1 or another slice without a new owner launch.
