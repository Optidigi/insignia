...
The [M0-001 prompt](../../docs/delivery/prompts/M0-001-same-variant-dev-lifecycle.md) records the original harness scope. The [M0-002 receipts](evidence/m0-002/README.md) preserve the historical native failure. The current [M0-003 prompt](../../docs/delivery/prompts/M0-003-fulfillment-selection-diagnosis.md), [diagnostic evidence](evidence/m0-003/README.md) and [G1 record](../evidence/G1.md) distinguish local checks, development-store observations and outstanding public-app qualification.
