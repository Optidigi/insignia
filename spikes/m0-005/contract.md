...
2. TypeScript writer owns `spikes/m0-005/ts/**` and TypeScript tests. Implement canonical issue/decode and independent fixture literals; issuer code does not implement Ed25519 point arithmetic. Use the existing allocator through explicit import for exact-money controls. The Rust core and both complete targets own verification and key admission.
