...
Fresh restricted Spec and Standards/correctness review results and fixes are recorded in the review packet after the final diff is fixed. Principal gate acceptance, architecture direction and PR review remain external. The outcome PR is not authorized to merge.
