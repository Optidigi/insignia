...
- Both reviewers checked the retained 28-row matrix and over-limit flags, and neither granted gate or PR approval. Narrow fresh follow-up on these corrections is pending final candidate commit.
